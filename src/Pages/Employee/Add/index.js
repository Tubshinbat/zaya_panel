...
const Add = (props) => {
  ...
  return (
    <Section>
      <MetaTags>
        <title> Хамт олонд хүн нэмэх | WEBR Control Panel</title>
        <meta
          name="description"
          content="Хамт олонд хүн нэмэх | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Хамт олонд хүн нэмэх | web control panel"
        />
      </MetaTags>

      <PageTitle name={`Хамт олонд хүн нэмэх `} />
      <div className="row">
