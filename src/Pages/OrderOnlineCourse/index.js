...
const Serives = (props) => {
  ...
  return (
    <Section>
      <MetaTags>
        <title> Онлайн сургалтын бүртгэл | WEBR Control Panel</title>
        <meta
          name="description"
          content="Онлайн сургалтын бүртгэл | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Онлайн сургалтын бүртгэл | web control panel"
        />
      </MetaTags>
      <PageTitle name={`Онлайн сургалтын бүртгэл`} />
        ...
        <div className={css.PanelControl}>
          <div className="col-md-4">
            <div className={css.PanelTabelHeader}>
              ...
              >
                <i className="fas fa-plus-circle"></i> Онлайн сургалтын бүртгэл
                оруулах{" "}
              </button>
              <button
                name="refresh"
