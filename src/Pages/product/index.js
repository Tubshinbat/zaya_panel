...
const News = (props) => {
  ...
  const [select, setSelect] = useState(
    "status name slug categories pictures priceVal type createAt"
  );
  ...
  return (
    <Section>
      <MetaTags>
        <title> Бараа бүтээгдэхүүн | WEBR Control Panel</title>
        <meta
          name="description"
          content="Бараа бүтээгдэхүүн | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Бараа бүтээгдэхүүн | web control panel"
        />
      </MetaTags>
      <PageTitle name={`Бараа бүтээгдэхүүн`} />
        ...
        <div className={css.PanelControl}>
          <div className="col-md-4">
            <div className={css.PanelTabelHeader}>
              ...
              >
                <i className="fas fa-plus-circle"></i> Бараа бүтээгдэхүүн нэмэх
              </button>
              <button
                name="refresh"
                onClick={() => init()}
                      ...
                      <td>
                        <div className={css.AllActions}>
                          <a
                            ...
                            href={`${myBase.siteUrl}product/${el.slug}`}
                            target="_blank"
                          >
