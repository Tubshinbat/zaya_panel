...
const Add = (props) => {
  ...
  useEffect(() => {
    if (props.product) {
      setForm(() => ({
        ...props.product,
        createUser: props.product.createUser && props.product.createUser._id,
      }));

      setPhotos(props.product.pictures);
      setForm((bf) => ({ ...bf, pictures: props.product.pictures }));
      checkFrom("pictures", props.product.pictures);
              ...
              <div className="col-md-12">
                <div className="form-group input-group-sm">
                  ...
                  <input
                    ...
                    type="text"
                    name="name"
                    placeholder=" Бүтээгдэхүүнийн гарчиг оруулна уу"
                    value={formData.name}
