...
const Add = (props) => {
  ...
  return (
    <Section>
      <MetaTags>
        <title> Бараа бүтээгдэхүүн нэмэх | WEBR Control Panel</title>
        <meta
          name="description"
          content="Бараа бүтээгдэхүүн нэмэх | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Бараа бүтээгдэхүүн нэмэх | web control panel"
        />
      </MetaTags>

      <PageTitle name={`Бараа бүтээгдэхүүн нэмэх `} />
      <div className="row">
          ...
          <CardBoby>
            <div className={`${css.AddForm} row`}>
              <div className="col-md-12">
                <div className="form-group input-group-sm">
                  ...
                  <input
                    ...
                    type="text"
                    name="name"
                    placeholder="Бараа бүтээгдэхүүнийн гарчиг оруулна уу"
                    value={formData.name}
              ...
              <div className="col-md-9">
                <div className="form-group input-group-sm">
                  <p className={`${css.Title}`}> Бүтээгдэхүүний үнэ </p>
                  <input
                    className="form-control"
                    type="number"
                    name="price"
          ...
          <div className="card card-primary card-outline">
            <div className="card-header">
              <h3 className="card-title">
                <i className="far fa-image"></i> Бараа бүтээгдэхүүнын зураг
              </h3>
            </div>
