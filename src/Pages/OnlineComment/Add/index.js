...
const Add = (props) => {
  ...
  return (
    <Section>
      <MetaTags>
        <title> Сургалтын бүртгэл нэмэх | WEBR Control Panel</title>
        <meta
          name="description"
          content="Сургалтын бүртгэл нэмэх | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Сургалтын бүртгэл нэмэх | web control panel"
        />
      </MetaTags>

      <PageTitle name={`Сургалтын бүртгэл нэмэх `} />
      <div className="row">
