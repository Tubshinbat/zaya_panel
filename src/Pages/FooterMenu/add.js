...
// ACTIONS
import { saveMenu } from "../../redux/actions/footerMenuActions";
    ...
    <>
      <div className="form-group">
        <div className="custom-control custom-switch">
          ...
          />
          <label className="custom-control-label" htmlFor="direct_is">
            Линк холбох
          </label>
        </div>
      </div>
      <div className="form-group">
        <div className="custom-control custom-switch">
          <input
            ...
            onChange={handleRadio}
          />
          <label className="custom-control-label" htmlFor="model_is">
            Модел холбох
          </label>
        </div>
      </div>
      <div className="form-group">
        <input
          ...
          type="text"
          value={formData.name || ""}
          placeholder="Цэсний нэр жнь: Podcast, Танд хэрэгтэй"
