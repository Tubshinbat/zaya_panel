...
const Serives = (props) => {
  ...
  const init = () => {
    ...
    props.loadServices(`select=${select}`);
  };
  ...
  return (
    <Section>
      <MetaTags>
        <title> Үйлчилгээ | WEBR Control Panel</title>
        <meta name="description" content="Үйлчилгээ | WeBR control panel" />
        <meta property="og:title" content="Үйлчилгээ | web control panel" />
      </MetaTags>
      <PageTitle name={`Үйлчилгээ`} />
        ...
        <div className={css.PanelControl}>
          <div className="col-md-4">
            <div className={css.PanelTabelHeader}>
              ...
              >
                <i className="fas fa-plus-circle"></i> Үйлчилгээ оруулах{" "}
              </button>
              <button
                name="refresh"
                onClick={() => init()}
                      ...
                      <td>
                        <div className={css.AllActions}>
                          <a
                            ...
                            href={`${myBase.siteUrl}service/${el.slug}`}
                            target="_blank"
                          >
...
const mapStateToProps = (state) => {
  return {
    ...
    pageLast: state.serviceReducer.paginationLast,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    loadServices: (query) => dispatch(actions.loadServices(query)),
    loadPagination: (pageLast) => dispatch(actions.loadPagination(pageLast)),
    deleteMultService: (ids) => dispatch(actions.deleteMultService(ids)),
  };
};
