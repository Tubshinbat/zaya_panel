          ...
          <CardBoby>
            <div className={`${css.AddForm} row`}>
              ...
              <div className="col-md-9">
                <div className="form-group input-group-sm">
                  <p className={`${css.Title}`}> Үйлчилгээний үнэ </p>
                  <input
                    className="form-control"
                    type="number"
                    name="price"
              ...
              <div className="col-md-12">
                <div className="form-group">
                  <p className={`${css.Title}`}> Үйлчилгээний хураангуй </p>
                  <textarea
                    className="form-control"
                    name="shortDetails"
                    onChange={handleChange}
              ...
              <div className="col-md-12">
                <div className="form-group">
                  <p className={`${css.Title}`}> Үйлчилгээний дэлгэрэнгүй </p>
                  <Editor
