...
const Edit = (props) => {
  ...
  useEffect(() => {
    if (props.success) {
      ...
      props.clear();
      setTimeout(() => props.history.replace("/service"), 2000);
    }
  }, [props.success]);
  ...
  useEffect(() => {
    if (props.service) {
      ...
      setPhotos(props.service.pictures);
      setForm((bf) => ({ ...bf, pictures: props.service.pictures }));
      checkFrom("pictures", props.service.pictures);
      setErrors((bf) => ({ ...bf, pictures: true }));

      let c = [];
      props.service.teachers &&
        props.service.teachers.map((el) => c.push(el._id));
  ...
  return (
    <Section>
      <MetaTags>
        <title> Үйлчилгээ нэмэх | WEBR Control Panel</title>
        <meta
          name="description"
          content="Үйлчилгээ нэмэх | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Үйлчилгээ нэмэх | web control panel"
        />
      </MetaTags>
              ...
              <div className="col-md-12">
                <div className="form-group input-group-sm">
                  ...
                  <input
                    ...
                    type="text"
                    name="name"
                    placeholder="Үйлчилгээийн гарчиг оруулна уу"
                    value={formData.name}
          ...
          <div className="card card-primary card-outline">
            <div className="card-header">
              <h3 className="card-title">
                <i className="far fa-image"></i> Үйлчилгээний зураг
              </h3>
            </div>
